...
public class InventarioBusiness {
	...
	/** método de la capa de negocio que añade una montura al inventario
	 ...
	 * @param motorizada true si está motorizada, false en caso contrario
	 * @return true si se ha añadido, false si ha habido algun error
	 */
	...
	/** método de la capa de negocio que añade un tubo óptico al inventario
	...
	/** método de la capa de negocio que añade unos nuevos oculares al inventario
	...
	/** método de la capa de negocio que añade un nuevo set de equipamiento
	...
	/** método de la capa de negocio que añade un nuevo tipo de tubo
	...
	/** método de la capa de negocio que añade un nuevo tipo de montura
	...
	/** método de la capa de negocio que descataloga una montura
	...
	/** método de la capa de negocio que descataloga un tubo
	...
	/** método de la capa de negocio que descataloga un ocular
	...
	/** método de la capa de negocio que anhade un estado a la lista de estados
	 * @param id del estado
	...
	/** método de la capa de negocio que hace una consulta de todos los objetos del inventario
	 * @return consulta
	 */
	...
	/** método de la capa de negocio que actualiza el estado de un equipamiento
